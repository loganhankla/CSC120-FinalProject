...
public class Camper extends Person {
    ...
    /** Severity level out of 3: 1 being least serious, 3 being most */
    public int severity;

    /** Current camper's primary complaint body part */
    public String primaryComplaint;

    /** The appropriate/expected treatment object to be used based on primary complaint */
    public String appropriateTreatment;
    
    /**
     * Camper constructor, child of person class
    ...
    /** Method for camper to give their primary complaint to the Nurse, called when Nurse asks for intake. */
    ...
    /** Prints the camper's more in-depth explanation of their arm complaint depending on the level of severity. */
    ...
    /** Randomly determines the level of severity for the primary complaint.
     * @return severity int 1-3
     * @throws RuntimeException if complaint unexpected
     */
    ...
    /** Calls for camper's in-depth explanation of their malady depending on their random primary complaint. */
    public void explain(){
        this.getSeverity();
        if(this.primaryComplaint == "arm"){
            getArmExplanation();
        } else if(this.primaryComplaint == "stomach"){
            getStomachExplanation();
        } else if(this.primaryComplaint == "ankle"){
            getAnkleExplanation();
        } else if(this.primaryComplaint == "rash"){
            getRashExplanation();
        } else if(this.primaryComplaint == "head"){
            getHeadExplanation();
        } else{
    ...
    /** Prints the camper's more in-depth explanation of their head complaint depending on the level of severity. */
    public void getHeadExplanation(){
     ...
     /** Prints the camper's more in-depth explanation of their rash complaint depending on the level of severity. */
    public void getRashExplanation(){
     ...
     /** Prints the camper's more in-depth explanation of their ankle complaint depending on the level of severity. */
    public void getAnkleExplanation(){
     ...
     /** Prints the camper's more in-depth explanation of their stomach complaint depending on the level of severity. */
